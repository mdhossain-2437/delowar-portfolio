  ...
  const impacts = [
    {
      ...
      description:
        "Built a complete online store that processes 100+ orders daily, increasing revenue by 300%",
      stats: [
        {
          label: "Daily Orders",
          value: "100+",
    ...
    },
    {
      ...
      description:
        "Automated attendance, grading, and parent communication, saving 15+ hours per week for teachers",
      stats: [
        {
          label: "Time Saved",
          value: "15h/week",
    ...
    },
    {
      ...
      description:
        "Created a tool used by 500+ developers to build professional portfolios in minutes",
      stats: [
        {
          label: "Active Users",
          value: "500+",
    ...
    },
    {
      ...
      client: "Retail Chain",
      description:
        "Streamlined stock management across 3 stores, reducing waste by 40% and increasing efficiency",
      stats: [
        {
          label: "Waste Reduced",
          value: "-40%",
          ...
          <Card className="glass-card p-8 max-w-3xl mx-auto">
            <CardContent>
              ...
              <p className="text-lg text-slate-400 leading-relaxed mb-6">
                ...
                These aren't just projects—they're solutions that help
                businesses grow, teachers save time, and developers build their
                careers. Every line of code serves a purpose, and every feature
                solves a real problem.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-border">
                <div className="text-center">
                  <div className="text-3xl font-bold text-accent mb-1">10+</div>
                  <div className="text-sm text-slate-500">Live Projects</div>
                </div>
                <div className="text-center">
